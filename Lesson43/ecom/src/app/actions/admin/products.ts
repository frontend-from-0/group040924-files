...
export async function addNewProductAction(
  ...
  try {
    ...
    await setDoc(doc(db, collections.products, id), {
      ...
      stripePriceId: 'price_1RtBS9QitHtctVUTVPL5QlKn', // TODO: replace with the actual price ID
      stripeProductId: 'prod_N1a2b3c4d5e6f7g8h9i0j', // TODO: replace with the actual product ID
      meta: {
        createdAt: dateNow,
        updatedAt: dateNow,
      },
